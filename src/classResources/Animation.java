...
/**
 * Generated by Gemini AI <p>
 *
 * A utility class for handling sprite sheet animations.
 * It splits a single image into multiple frames and manages time-based playback.
 */
public class Animation {
    ...
    /** Map containing actions (e.g. sounds) to be executed on specific frame indices. */
    private final Map<Integer, Runnable> frameTriggers = new HashMap<>();

    /** Tracking the last triggered frame to prevent duplicate execution within one frame duration. */
    private int lastTriggeredFrame = -1;

    /**
     * Constructs a new SpriteAnimation by slicing a sprite sheet.
     * @param spriteSheet   The source image containing all frames.
     * @param rows          Number of vertical divisions.
     * @param cols          Number of horizontal divisions.
     * @param totalFrames   Total frames to extract
     * @param frameDuration How long each frame stays on screen (in seconds).
     */
    ...
    /**
     * Internal check for registered triggers on the current frame.
     */
